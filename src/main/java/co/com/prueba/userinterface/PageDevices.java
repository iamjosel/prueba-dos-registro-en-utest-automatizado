...
public class PageDevices {
    public static final Target CONTAINER_COMPUTER = Target.the("Container computer")
    ...
    public static final Target CONTAINER_VERSION = Target.the("Container Version")
    ...
    public static final Target CONTAINER_LANGUAGE = Target.the("Container Language")
    ...
    public static final Target CONTAINER_MOBILE_DEVICE = Target.the("Container Mobile Device")
    ...
    public static final Target CONTAINER_MOBILE_MODEL = Target.the("Container Mobile Model")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/div[1]/div[3]/div[2]/div[2]/div[2]/div"));
    public static final Target MOBILE_MODEL = Target.the("Mobile Model")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/div[1]/div[3]/div[2]/div[2]/div[2]/div/input[1]"));

    public static final Target CONTAINER_OPERATING_SYSTEM = Target.the("Container Operating System")
    ...
    public static final Target BUTTON_FINISH = Target.the("Button section finish")
